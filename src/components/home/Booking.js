                ...
                <div className="container_inner">
                  <div className="container_top">
                    <div className="container_guestsWrapper">
                      <button className="container_guests"
                        ...
                        <span>{adultQuantity} Adult</span>, <span>{childQuantity} Children</span>
                      </button>
                      {isExpanded && (
                        <div className="container_form_guests">
                          <fieldset>
                            ...
                            <div className="button_group">
                              ...
                              <button className="btn button_btn button_primary button_sm" datatest="Button">
                                <span>Apply</span>
                              </button>
                            </div>
                          </fieldset>
