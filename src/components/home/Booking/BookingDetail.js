...
function BookingDetail({ showDetails, setShowDetails, showDetailsBill, setShowDetailsBill, toggleForm, showAddon, showForm, cancelForm, adultQuantity, childQuantity, handleBack, handleNext }) {
